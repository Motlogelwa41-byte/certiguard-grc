 ...
 */
export function generatePostureReportHTML({ controls, risks, evidence, tasks, frameworks, generatedBy = "CertiGuard GRC" }) {
  const now = new Date();
...
<div class="page">
  ...
  <div class="footer">
    ...
    <span>Generated by CertiGuard GRC &nbsp;|&nbsp; ${format(now, "yyyy-MM-dd")}</span>
  </div>
