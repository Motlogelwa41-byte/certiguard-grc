...
export const CATALOG = [
  ...
  { service: "okta", label: "Okta", category: "identity", authMethod: "api_key", icon: KeyRound, connectorType: null, secretHint: "OKTA_API_TOKEN + OKTA_DOMAIN", description: "User directory, MFA enrollment, app assignments, lifecycle events.", frameworks: ["SOC 2","ISO 27001","HIPAA"] },
