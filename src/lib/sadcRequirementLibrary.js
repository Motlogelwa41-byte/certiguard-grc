...
// Regional framework adopted by SADC Member States as a template for national
// data protection legislation. Administered by the SADC Secretariat.

export const SADC_MODEL_LAW_REQUIREMENTS = [
  { requirement_id: "Art4", title: "Definitions & scope of personal data", section: "Chapter I — General Provisions", category: "privacy", is_mandatory: true, order_index: 1,
    description: "Personal data means any information relating to an identified or identifiable natural person. Processing means any operation or set of operations performed on personal data, including collection, recording, organisation, storage, adaptation, retrieval, use, disclosure, dissemination, and erasure.",
    guidance: "Maintain a data inventory classifying each field as personal data or not. Map to national law definitions where implemented." },
  { requirement_id: "Art5", title: "Lawful & fair processing", section: "Chapter II — General Principles", category: "privacy", is_mandatory: true, order_index: 2,
    description: "Personal data must be processed lawfully and fairly, with the knowledge or consent of the data subject, and only for specified, explicit and legitimate purposes.",
    guidance: "Document the lawful basis for each processing activity. Provide transparent privacy notices." },
  { requirement_id: "Art6", title: "Data minimisation & purpose limitation", section: "Chapter II — General Principles", category: "privacy", is_mandatory: true, order_index: 3,
    description: "Personal data must be adequate, relevant, and not excessive in relation to the purposes for which it is collected. Data must not be further processed in a manner incompatible with the original purpose.",
    guidance: "Review data collection forms annually. Document original purpose for each data category." },
  { requirement_id: "Art7", title: "Data quality & accuracy", section: "Chapter II — General Principles", category: "privacy", is_mandatory: true, order_index: 4,
    description: "Personal data must be accurate and kept up to date. Reasonable steps must be taken to rectify or erase inaccurate data without delay.",
    guidance: "Implement data quality controls and correction workflows." },
  { requirement_id: "Art8", title: "Storage limitation & retention", section: "Chapter II — General Principles", category: "privacy", is_mandatory: true, order_index: 5,
    description: "Personal data must not be kept in a form permitting identification of data subjects for longer than necessary for the purposes for which the data was collected.",
    guidance: "Define retention schedules per data category. Automate deletion or anonymisation." },
  { requirement_id: "Art9", title: "Security & confidentiality safeguards", section: "Chapter II — General Principles", category: "data_protection", is_mandatory: true, order_index: 6,
    description: "Controllers must implement appropriate technical and organisational measures to protect personal data against accidental or unlawful destruction, loss, alteration, unauthorised disclosure, or access.",
    guidance: "Implement ISO 27001 controls, encryption, access management, and regular security assessments." },
  { requirement_id: "Art10", title: "Accountability & transparency", section: "Chapter II — General Principles", category: "governance", is_mandatory: true, order_index: 7,
    description: "Controllers must be able to demonstrate compliance with the principles of data protection. Records of processing activities must be maintained and made available to the supervisory authority.",
    guidance: "Maintain a ROPA register. Conduct annual compliance audits." },
  { requirement_id: "Art12", title: "Consent of the data subject", section: "Chapter III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 8,
    description: "Processing of personal data must be based on the free, specific, and informed consent of the data subject, or on another legitimate basis specified in law. Consent must be documented and withdrawable at any time.",
    guidance: "Implement granular consent mechanisms. Record consent with timestamps. Provide easy withdrawal." },
  { requirement_id: "Art13", title: "Right to information & access", section: "Chapter III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 9,
    description: "Data subjects have the right to be informed about the processing of their personal data and to access a copy of their data, including the purposes, recipients, and retention period.",
    guidance: "Implement a data subject access request process with a 30-day SLA." },
  { requirement_id: "Art14", title: "Right to rectification & erasure", section: "Chapter III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 10,
    description: "Data subjects have the right to request the rectification of inaccurate data and the erasure of data that is no longer necessary, subject to legal retention exemptions.",
    guidance: "Implement correction and erasure workflows. Track third-party notifications." },
  { requirement_id: "Art15", title: "Right to object to processing", section: "Chapter III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 11,
    description: "Data subjects have the right to object to the processing of their personal data on legitimate grounds, including direct marketing. Controllers must stop processing upon valid objection.",
    guidance: "Provide opt-out mechanisms. Process objections within 30 days." },
  { requirement_id: "Art18", title: "Data Protection Officer designation", section: "Chapter IV — Controller Obligations", category: "governance", is_mandatory: true, order_index: 12,
    description: "Member States shall require controllers and processors to designate a Data Protection Officer responsible for ensuring compliance with the data protection law. The DPO must have expert knowledge and operate independently.",
    guidance: "Appoint a DPO and register with the national supervisory authority. Record in TenantSettings." },
  { requirement_id: "Art20", title: "Records of processing activities", section: "Chapter IV — Controller Obligations", category: "compliance", is_mandatory: true, order_index: 13,
    description: "Controllers must maintain written records of processing activities, including the purposes, data categories, recipients, cross-border transfers, retention periods, and security measures.",
    guidance: "Use the ROPA module. Review quarterly. Make available to the supervisory authority." },
  { requirement_id: "Art22", title: "Data Protection Impact Assessment", section: "Chapter IV — Controller Obligations", category: "compliance", is_mandatory: true, order_index: 14,
    description: "Controllers must conduct a DPIA for processing likely to result in a high risk to data subjects, including large-scale processing of sensitive data, systematic monitoring, or innovative technologies.",
    guidance: "Trigger DPIA for high-risk processing. Use the DPIA module." },
  { requirement_id: "Art25", title: "Processor & sub-processor agreements", section: "Chapter IV — Controller Obligations", category: "compliance", is_mandatory: true, order_index: 15,
    description: "Controllers must only use processors that provide sufficient guarantees of security. Processing must be governed by a written contract setting out the subject matter, duration, purposes, and obligations.",
    guidance: "Execute DPAs with all vendors. Track sub-processors in the Vendor module." },
  { requirement_id: "Art28", title: "Personal data breach notification", section: "Chapter V — Security & Breach Notification", category: "incident_response", is_mandatory: true, order_index: 16,
    description: "Controllers must notify the supervisory authority of a personal data breach within 72 hours of becoming aware of it, unless the breach is unlikely to result in a risk to data subjects. Affected data subjects must be notified if the breach is likely to result in a high risk.",
    guidance: "Implement a 72-hour breach notification workflow. Use the Incident module. Prepare notification templates." },
  { requirement_id: "Art30", title: "Restrictions on cross-border data transfers", section: "Chapter VI — Cross-Border Transfers", category: "data_protection", is_mandatory: true, order_index: 17,
    description: "Personal data must not be transferred to a third country unless that country ensures an adequate level of data protection, or appropriate safeguards are in place such as standard contractual clauses or binding corporate rules.",
    guidance: "Use the Cross-Border Matrix. Execute SCCs with cross-border processors. Document adequacy assessments." },
  { requirement_id: "Art32", title: "Special categories of personal data", section: "Chapter VII — Special Data", category: "privacy", is_mandatory: true, order_index: 18,
    description: "Processing of special categories of personal data (health, biometrics, racial origin, political opinions, religious beliefs, trade union membership, sexual life) is prohibited unless an exception applies: explicit consent, vital interests, legal obligation, or data made public by the subject.",
    guidance: "Identify and classify all special personal data. Apply enhanced controls. Require explicit consent." },
  { requirement_id: "Art35", title: "Children's data protections", section: "Chapter VII — Special Data", category: "privacy", is_mandatory: true, order_index: 19,
    description: "Processing of personal data of children requires the consent of a parent or guardian. Member States shall provide specific protections for children's data, including restrictions on marketing and profiling.",
    guidance: "Implement age verification and parental consent. Restrict marketing to children." },
  { requirement_id: "Art40", title: "Registration with supervisory authority", section: "Chapter VIII — Supervision & Enforcement", category: "compliance", is_mandatory: true, order_index: 20,
    description: "Every controller and processor must register with the national supervisory authority before commencing processing activities. Registration must be renewed as prescribed by national law.",
    guidance: "Complete registration before processing. Maintain records. Update when processing changes." },
];

// ── Namibia Data Protection Act (Act No. 3 of 2018) ──────────────────────────
// Administered by the Namibia Data Protection Authority. Closely modelled on
// the SADC Model Law and EU GDPR. Effective 2025.

export const NAMIBIA_DPA_REQUIREMENTS = [
  { requirement_id: "S1", title: "Definitions & scope", section: "Part I — Preliminary", category: "privacy", is_mandatory: true, order_index: 1,
    description: "Personal data means any information relating to an identified or identifiable natural person. Processing includes collection, recording, organisation, storage, adaptation, retrieval, use, disclosure, dissemination, alignment, combination, blocking, erasure, or destruction.",
    guidance: "Maintain a data inventory. Map each data field to the definition of personal data." },
  { requirement_id: "S6", title: "Lawful, fair & transparent processing", section: "Part II — Principles", category: "privacy", is_mandatory: true, order_index: 2,
    description: "Personal data must be processed lawfully, fairly, and in a transparent manner. Controllers must identify a lawful basis: consent, contract, legal obligation, vital interests, public task, or legitimate interests.",
    guidance: "Document the lawful basis for each processing activity in the ROPA." },
  { requirement_id: "S7", title: "Purpose limitation", section: "Part II — Principles", category: "privacy", is_mandatory: true, order_index: 3,
    description: "Personal data must be collected for specified, explicit and legitimate purposes and not further processed incompatibly.",
    guidance: "Record original collection purpose. Prevent repurposing without a new lawful basis." },
  { requirement_id: "S8", title: "Data minimisation", section: "Part II — Principles", category: "privacy", is_mandatory: true, order_index: 4,
    description: "Personal data must be adequate, relevant, and limited to what is necessary for the purposes of processing.",
    guidance: "Review collection forms annually. Remove unnecessary fields." },
  { requirement_id: "S9", title: "Accuracy", section: "Part II — Principles", category: "privacy", is_mandatory: true, order_index: 5,
    description: "Personal data must be accurate and kept up to date. Inaccurate data must be rectified or erased without delay.",
    guidance: "Implement data quality controls and correction workflows." },
  { requirement_id: "S10", title: "Storage limitation", section: "Part II — Principles", category: "privacy", is_mandatory: true, order_index: 6,
    description: "Personal data must not be kept longer than necessary for the purposes of processing. Retention schedules must be defined and enforced.",
    guidance: "Define retention periods per data category. Automate deletion at end of retention." },
  { requirement_id: "S11", title: "Integrity & confidentiality", section: "Part II — Principles", category: "data_protection", is_mandatory: true, order_index: 7,
    description: "Personal data must be processed securely using appropriate technical and organisational measures to protect against unauthorised or unlawful processing, accidental loss, destruction, or damage.",
    guidance: "Implement encryption, access controls, MFA, and security monitoring per ISO 27001." },
  { requirement_id: "S12", title: "Accountability", section: "Part II — Principles", category: "governance", is_mandatory: true, order_index: 8,
    description: "Controllers are responsible for and must demonstrate compliance with the data protection principles. Records of processing must be maintained.",
    guidance: "Maintain ROPA. Conduct annual compliance audits. Assign a DPO." },
  { requirement_id: "S15", title: "Right to information", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 9,
    description: "Data subjects have the right to be informed about the collection and use of their personal data, including the controller's identity, purposes, recipients, retention period, and rights.",
    guidance: "Publish clear privacy notices at collection points." },
  { requirement_id: "S16", title: "Right of access", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 10,
    description: "Data subjects have the right to obtain confirmation of processing and access to their personal data, along with information about purposes, recipients, and retention.",
    guidance: "Implement a DSAR process with a 30-day SLA. Use the Privacy Request portal." },
  { requirement_id: "S17", title: "Right to rectification", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 11,
    description: "Data subjects have the right to have inaccurate personal data rectified without undue delay. Third parties must be notified of rectifications.",
    guidance: "Provide correction mechanisms. Track third-party notifications." },
  { requirement_id: "S18", title: "Right to erasure", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 12,
    description: "Data subjects have the right to have their personal data erased where the data is no longer necessary, consent is withdrawn, or processing is unlawful.",
    guidance: "Implement verified erasure workflows. Document legal retention exemptions." },
  { requirement_id: "S19", title: "Right to object", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 13,
    description: "Data subjects have the right to object to processing based on legitimate interests, public task, or direct marketing. Controllers must stop processing unless compelling legitimate grounds exist.",
    guidance: "Provide opt-out mechanisms. Process objections within 30 days." },
  { requirement_id: "S20", title: "Rights regarding automated decisions", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 14,
    description: "Data subjects have the right not to be subject to solely automated decisions with legal or significant effects, unless necessary for a contract, authorised by law, or based on explicit consent.",
    guidance: "Implement human review for automated decisions. Provide information about the logic." },
  { requirement_id: "S24", title: "Data protection by design & default", section: "Part IV — Controller Obligations", category: "data_protection", is_mandatory: true, order_index: 15,
    description: "Controllers must implement appropriate technical and organisational measures to ensure that, by default, only necessary personal data is processed. This includes minimisation of collection, storage, and accessibility.",
    guidance: "Adopt privacy-by-design. Conduct DPIAs for high-risk processing. Configure most privacy-protective defaults." },
  { requirement_id: "S25", title: "Records of processing activities", section: "Part IV — Controller Obligations", category: "compliance", is_mandatory: true, order_index: 16,
    description: "Controllers and processors must maintain records of processing activities, including purposes, data categories, recipients, transfers, retention, and security measures.",
    guidance: "Use the ROPA module. Review quarterly. Make available to the supervisory authority." },
  { requirement_id: "S26", title: "DPIA for high-risk processing", section: "Part IV — Controller Obligations", category: "compliance", is_mandatory: true, order_index: 17,
    description: "Controllers must conduct a DPIA for processing likely to result in high risk to data subjects, including large-scale sensitive data processing, systematic monitoring, or innovative technologies.",
    guidance: "Trigger DPIA for high-risk processing. Use the DPIA module." },
  { requirement_id: "S27", title: "Data Protection Officer appointment", section: "Part IV — Controller Obligations", category: "governance", is_mandatory: true, order_index: 18,
    description: "Controllers must designate a DPO where core activities involve large-scale processing of sensitive data or regular systematic monitoring. The DPO must have expert knowledge and report to the highest management level.",
    guidance: "Appoint a DPO and register with the supervisory authority. Record in TenantSettings." },
  { requirement_id: "S28", title: "Processor agreements", section: "Part IV — Controller Obligations", category: "compliance", is_mandatory: true, order_index: 19,
    description: "Controllers must use only processors providing sufficient security guarantees. Processing must be governed by a written contract specifying the subject matter, duration, purposes, data types, and processor obligations.",
    guidance: "Execute DPAs with all vendors. Track sub-processors in the Vendor module." },
  { requirement_id: "S31", title: "Security of processing", section: "Part V — Security & Breach Notification", category: "data_protection", is_mandatory: true, order_index: 20,
    description: "Controllers and processors must implement appropriate technical and organisational measures to ensure security appropriate to the risk, including encryption, confidentiality, integrity, availability, and regular testing.",
    guidance: "Implement ISO 27001 controls. Conduct penetration testing annually." },
  { requirement_id: "S32", title: "Breach notification to supervisory authority", section: "Part V — Security & Breach Notification", category: "incident_response", is_mandatory: true, order_index: 21,
    description: "Controllers must notify the supervisory authority of a personal data breach within 72 hours of becoming aware, unless unlikely to result in risk to data subjects. Notification must include nature, categories, approximate numbers, likely consequences, and measures taken.",
    guidance: "Implement a 72-hour notification workflow. Use the Incident module. Draft notification templates." },
  { requirement_id: "S33", title: "Breach communication to data subjects", section: "Part V — Security & Breach Notification", category: "incident_response", is_mandatory: true, order_index: 22,
    description: "When a breach is likely to result in high risk to data subjects, the controller must communicate the breach to affected individuals without undue delay, describing the nature and providing advice on protective measures.",
    guidance: "Prepare breach notification templates. Define high-risk criteria. Coordinate with communications." },
  { requirement_id: "S36", title: "Cross-border transfer restrictions", section: "Part VI — Cross-Border Transfers", category: "data_protection", is_mandatory: true, order_index: 23,
    description: "Personal data must not be transferred to a third country unless the receiving country ensures adequate protection, or appropriate safeguards are in place such as SCCs, binding corporate rules, or approved codes of conduct.",
    guidance: "Use the Cross-Border Matrix. Execute SCCs. Document adequacy assessments in the ROPA." },
  { requirement_id: "S38", title: "Special personal information", section: "Part VII — Special Data", category: "privacy", is_mandatory: true, order_index: 24,
    description: "Special personal information (health, biometrics, racial origin, political opinions, religious beliefs, trade union membership, sexual life, criminal behaviour) must not be processed unless an exception applies: explicit consent, vital interests, legal obligation, or data made public.",
    guidance: "Classify special personal data. Apply enhanced controls. Require explicit consent." },
  { requirement_id: "S39", title: "Children's data", section: "Part VII — Special Data", category: "privacy", is_mandatory: true, order_index: 25,
    description: "Processing of children's personal data requires parental or guardian consent. Children's data must not be used for marketing or profiling without consent.",
    guidance: "Implement age verification and parental consent. Restrict marketing to children." },
  { requirement_id: "S42", title: "Registration with supervisory authority", section: "Part VIII — Registration & Enforcement", category: "compliance", is_mandatory: true, order_index: 26,
    description: "Every controller and processor must register with the supervisory authority before processing personal data. Registration must include controller details, purposes, data categories, and transfers.",
    guidance: "Complete registration before processing. Maintain records. Update when processing changes." },
];

// ── Zimbabwe Data Protection Act (Act No. 5 of 2010) ─────────────────────────
// Administered by the Postal and Telecommunications Regulatory Authority of
// Zimbabwe (POTRAZ). Amended 2021 to strengthen data subject rights.

export const ZIMBABWE_DPA_REQUIREMENTS = [
  { requirement_id: "S2", title: "Definitions & scope", section: "Part I — Preliminary", category: "privacy", is_mandatory: true, order_index: 1,
    description: "Personal data means any information relating to an identified or identifiable natural person. Processing includes any operation performed on personal data, including collection, recording, organisation, storage, adaptation, retrieval, use, disclosure, and erasure.",
    guidance: "Maintain a data inventory. Map each data field to the definition." },
  { requirement_id: "S5", title: "Lawful & fair processing", section: "Part II — Principles", category: "privacy", is_mandatory: true, order_index: 2,
    description: "Personal data must be processed lawfully and fairly. Controllers must identify a lawful basis before processing: consent, contract, legal obligation, vital interests, or legitimate interests.",
    guidance: "Document the lawful basis for each processing activity in the ROPA." },
  { requirement_id: "S6", title: "Purpose limitation & minimisation", section: "Part II — Principles", category: "privacy", is_mandatory: true, order_index: 3,
    description: "Personal data must be collected for specified, explicit and legitimate purposes and not further processed incompatibly. Only the minimum data necessary for the purpose may be collected.",
    guidance: "Document collection purpose. Review forms for minimisation annually." },
  { requirement_id: "S7", title: "Data quality", section: "Part II — Principles", category: "privacy", is_mandatory: true, order_index: 4,
    description: "Personal data must be accurate, complete, and kept up to date. Reasonable steps must be taken to rectify or erase inaccurate data.",
    guidance: "Implement data quality controls and correction workflows." },
  { requirement_id: "S8", title: "Storage limitation", section: "Part II — Principles", category: "privacy", is_mandatory: true, order_index: 5,
    description: "Personal data must not be kept longer than necessary for the purposes of processing. Retention schedules must be defined and enforced.",
    guidance: "Define retention periods per data category. Automate deletion." },
  { requirement_id: "S9", title: "Security safeguards", section: "Part II — Principles", category: "data_protection", is_mandatory: true, order_index: 6,
    description: "Controllers must implement appropriate technical and organisational measures to protect personal data against unauthorised access, accidental loss, destruction, or damage. Measures must be proportionate to the risk.",
    guidance: "Implement encryption, access controls, MFA, and security monitoring per ISO 27001." },
  { requirement_id: "S10", title: "Accountability", section: "Part II — Principles", category: "governance", is_mandatory: true, order_index: 7,
    description: "Controllers must be able to demonstrate compliance with the data protection principles. Records of processing must be maintained and available to POTRAZ.",
    guidance: "Maintain ROPA. Conduct annual audits. Assign a DPO." },
  { requirement_id: "S12", title: "Consent", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 8,
    description: "Processing must be based on the free, specific, and informed consent of the data subject, or another lawful basis. Consent must be documented and withdrawable.",
    guidance: "Implement granular consent mechanisms. Record consent with timestamps. Provide easy withdrawal." },
  { requirement_id: "S13", title: "Right to information", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 9,
    description: "Data subjects have the right to be informed about the collection and use of their personal data, including the controller's identity, purposes, recipients, and retention period.",
    guidance: "Publish clear privacy notices at collection points." },
  { requirement_id: "S14", title: "Right of access", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 10,
    description: "Data subjects have the right to obtain confirmation of processing and access to their personal data, along with information about purposes, recipients, and retention.",
    guidance: "Implement a DSAR process with a 30-day SLA. Use the Privacy Request portal." },
  { requirement_id: "S15", title: "Right to rectification & erasure", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 11,
    description: "Data subjects have the right to have inaccurate data rectified and to request erasure of data that is no longer necessary, subject to legal retention exemptions.",
    guidance: "Implement correction and erasure workflows. Track third-party notifications." },
  { requirement_id: "S16", title: "Right to object", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 12,
    description: "Data subjects have the right to object to processing on legitimate grounds, including direct marketing. Controllers must stop processing upon valid objection.",
    guidance: "Provide opt-out mechanisms. Process objections within 30 days." },
  { requirement_id: "S17", title: "Automated decision-making protections", section: "Part III — Data Subject Rights", category: "privacy", is_mandatory: true, order_index: 13,
    description: "Data subjects have the right not to be subject to solely automated decisions with legal or significant effects. Controllers must provide human review and information about the logic.",
    guidance: "Implement human-in-the-loop review. Provide meaningful information about automated decisions." },
  { requirement_id: "S20", title: "Data protection by design & default", section: "Part IV — Controller Obligations", category: "data_protection", is_mandatory: true, order_index: 14,
    description: "Controllers must implement appropriate technical and organisational measures to ensure that, by default, only necessary personal data is processed. Privacy must be built into systems from the design stage.",
    guidance: "Adopt privacy-by-design. Conduct DPIAs for high-risk processing." },
  { requirement_id: "S21", title: "Records of processing activities", section: "Part IV — Controller Obligations", category: "compliance", is_mandatory: true, order_index: 15,
    description: "Controllers and processors must maintain records of processing activities, including purposes, data categories, recipients, transfers, retention, and security measures.",
    guidance: "Use the ROPA module. Review quarterly. Make available to POTRAZ." },
  { requirement_id: "S22", title: "DPIA for high-risk processing", section: "Part IV — Controller Obligations", category: "compliance", is_mandatory: true, order_index: 16,
    description: "Controllers must conduct a DPIA for processing likely to result in high risk to data subjects, including large-scale sensitive data, systematic monitoring, or innovative technologies.",
    guidance: "Trigger DPIA for high-risk processing. Use the DPIA module." },
  { requirement_id: "S23", title: "Data Protection Officer", section: "Part IV — Controller Obligations", category: "governance", is_mandatory: true, order_index: 17,
    description: "Controllers must designate a DPO where core activities involve large-scale processing of sensitive data or regular systematic monitoring. The DPO must have expert knowledge and independence.",
    guidance: "Appoint a DPO and register with POTRAZ. Record in TenantSettings." },
  { requirement_id: "S24", title: "Processor agreements", section: "Part IV — Controller Obligations", category: "compliance", is_mandatory: true, order_index: 18,
    description: "Controllers must use only processors providing sufficient security guarantees. Processing must be governed by a written contract specifying purposes, duration, data types, and processor obligations.",
    guidance: "Execute DPAs with all vendors. Track sub-processors in the Vendor module." },
  { requirement_id: "S27", title: "Security of processing", section: "Part V — Security & Breach Notification", category: "data_protection", is_mandatory: true, order_index: 19,
    description: "Controllers and processors must implement appropriate technical and organisational measures to ensure a level of security appropriate to the risk, including encryption, confidentiality, integrity, and regular testing.",
    guidance: "Implement ISO 27001 controls. Conduct penetration testing annually." },
  { requirement_id: "S28", title: "Breach notification to POTRAZ", section: "Part V — Security & Breach Notification", category: "incident_response", is_mandatory: true, order_index: 20,
    description: "Controllers must notify POTRAZ of a personal data breach within 72 hours of becoming aware, unless unlikely to result in risk to data subjects. Notification must include the nature, categories, consequences, and measures taken.",
    guidance: "Implement a 72-hour notification workflow. Use the Incident module. Draft templates." },
  { requirement_id: "S29", title: "Breach communication to data subjects", section: "Part V — Security & Breach Notification", category: "incident_response", is_mandatory: true, order_index: 21,
    description: "When a breach is likely to result in high risk to data subjects, the controller must communicate the breach to affected individuals without undue delay, with advice on protective measures.",
    guidance: "Prepare breach notification templates. Define high-risk criteria." },
  { requirement_id: "S32", title: "Cross-border transfer restrictions", section: "Part VI — Cross-Border Transfers", category: "data_protection", is_mandatory: true, order_index: 22,
    description: "Personal data must not be transferred to a third country unless the receiving country ensures adequate protection, or appropriate safeguards are in place such as SCCs or binding corporate rules.",
    guidance: "Use the Cross-Border Matrix. Execute SCCs. Document adequacy assessments." },
  { requirement_id: "S34", title: "Special personal information", section: "Part VII — Special Data", category: "privacy", is_mandatory: true, order_index: 23,
    description: "Special personal information (health, biometrics, racial origin, political opinions, religious beliefs, trade union membership, sexual life, criminal behaviour) must not be processed unless an exception applies.",
    guidance: "Classify special personal data. Apply enhanced controls. Require explicit consent." },
  { requirement_id: "S35", title: "Children's data protections", section: "Part VII — Special Data", category: "privacy", is_mandatory: true, order_index: 24,
    description: "Processing of children's personal data requires parental or guardian consent. Children's data must not be used for marketing or profiling without consent.",
    guidance: "Implement age verification and parental consent. Restrict marketing to children." },
  { requirement_id: "S38", title: "Registration with POTRAZ", section: "Part VIII — Registration & Enforcement", category: "compliance", is_mandatory: true, order_index: 25,
    description: "Every controller and processor must register with POTRAZ before processing personal data. Registration must include controller details, purposes, data categories, and transfers.",
    guidance: "Complete registration before processing. Maintain records. Update when processing changes." },
];
...
export const SADC_REQUIREMENT_LIBRARIES = {
  ...
  sadc_model_law: { framework_code: "sadc_model_law", name: "SADC Model Law on Data Protection", requirements: SADC_MODEL_LAW_REQUIREMENTS },
  namibia_dpa: { framework_code: "namibia_dpa", name: "Namibia Data Protection Act", requirements: NAMIBIA_DPA_REQUIREMENTS },
  zimbabwe_dpa: { framework_code: "zimbabwe_dpa", name: "Zimbabwe Data Protection Act", requirements: ZIMBABWE_DPA_REQUIREMENTS },
};