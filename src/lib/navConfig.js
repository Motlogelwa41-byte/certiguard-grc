...
export const navSections = [
  {
    ...
    items: [
      ...
      { label: "Post-Launch Checklist", path: "/post-launch-checklist", icon: ClipboardList, roles: ["admin", "compliance_officer"] },
      { label: "Feedback Surveys", path: "/feedback-surveys", icon: MessageSquare, roles: ["admin", "compliance_officer"] },
    ]
  },
  {
    ...
    items: [
      ...
      { label: "SADC Performance Summary", path: "/sadc-readiness-summary", icon: ClipboardCheck, roles: ["admin", "compliance_officer", "risk_manager", "auditor", "executive"] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Privileged Access (PAM)", path: "/pam", icon: UserCog, roles: ["admin", "compliance_officer", "risk_manager", "auditor"] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Remediation Sync", path: "/remediation-sync", icon: ArrowLeftRight, roles: ["admin", "compliance_officer", "risk_manager"] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Data Classification", path: "/data-classification", icon: Layers, roles: ["admin", "compliance_officer", "auditor"] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Exec Risk Report", path: "/executive-risk-report", icon: LineChart, roles: ["admin", "compliance_officer", "risk_manager", "auditor", "executive"] },
      { label: "Board Report", path: "/board-report", icon: Presentation, roles: ["admin", "compliance_officer", "risk_manager", "auditor", "executive"] },
      { label: "Audit Readiness Report", path: "/audit-readiness-report", icon: ClipboardCheck, roles: ["admin", "compliance_officer", "risk_manager", "auditor", "executive"] },
      ...
      { label: "Reports", path: "/reports", icon: FileDown, roles: ["admin", "compliance_officer", "risk_manager", "auditor", "external_auditor", "regulator", "executive"] },
      ...
      { label: "Exec Readiness Dashboard", path: "/executive-readiness-dashboard", icon: LineChart, roles: ["admin", "compliance_officer", "risk_manager", "auditor", "executive"] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Identity & Access Center", path: "/identity-access", icon: Fingerprint, roles: ["admin", "compliance_officer", "risk_manager", "auditor"] },
      { label: "Cryptography Center", path: "/cryptography", icon: Lock, roles: ["admin", "compliance_officer", "risk_manager", "auditor"] },
