...
export default function Reports() {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      pdf.text("CertiGuard — Board Report", pageWidth / 2, 18, { align: "center" });
      pdf.setFontSize(10);
      ...
      pdf.text("Generated by CertiGuard GRC Platform — Confidential", pageWidth / 2, 290, { align: "center" });

      pdf.save(`CertiGuard_Report_${new Date().toISOString().slice(0, 10)}.pdf`);
  ...
  return (
    <div>
      ...
      <div className="bg-card rounded-xl border border-border p-6 mb-6" id="report-preview">
        <h2 className="font-heading text-lg font-bold text-foreground mb-1">CertiGuard — Board Report</h2>
        ...
        <div className="border-t border-border pt-4">
          <p className="text-[10px] text-muted-foreground">Generated by CertiGuard GRC Platform — Confidential</p>
        </div>
      </div>
