...
const SADC_LIBRARY = [
  ...
  // ── Botswana Regulator Pack ──────────────────────────────────────────────
  {
    id: "bocra_bw",
    region: "Botswana",
    flag: "🇧🇼",
    name: "BOCRA",
    full_name: "Botswana Communications Regulatory Authority",
    version: "BCRA 2012 (as amended)",
    category: "Telecommunications & ICT",
    authority: "Botswana Communications Regulatory Authority (BOCRA)",
    description: "Regulates telecommunications, postal services, broadcasting, and data protection in Botswana; issues operator licences and enforces quality, consumer protection, and cyber/data security standards.",
    mandatory: true,
    controls_count: 30,
    key_requirements: ["Operator licensing & compliance", "Quality of service standards", "Consumer protection", "Data protection & privacy", "Cybersecurity incident reporting", "Spectrum management", "Universal access obligations"],
    related_international: ["GDPR", "ITU", "SADC Model Law"],
    tags: ["telecommunications", "ict", "data protection", "botswana", "mandatory"],
  },
  {
    id: "bomra_bw",
    region: "Botswana",
    flag: "🇧🇼",
    name: "BOMRA",
    full_name: "Botswana Medicines Regulatory Authority",
    version: "BOMRA Act 2013 (as amended)",
    category: "Healthcare & Pharma",
    authority: "Botswana Medicines Regulatory Authority (BOMRA)",
    description: "Regulates medicines, medical devices, and clinical trials in Botswana; ensures safety, efficacy, quality, and Good Manufacturing Practice compliance across the pharmaceutical supply chain.",
    mandatory: true,
    controls_count: 28,
    key_requirements: ["Medicine registration & licensing", "Good Manufacturing Practice (GMP)", "Pharmacovigilance & adverse event reporting", "Clinical trial authorisation", "Quality control & batch release", "Supply chain integrity", "Recall procedures"],
    related_international: ["WHO GMP", "ICH", "ISO 13485"],
    tags: ["healthcare", "pharma", "medicines", "botswana", "mandatory"],
  },
  {
    id: "nbifira_bw",
    region: "Botswana",
    flag: "🇧🇼",
    name: "NBIFIRA",
    full_name: "Non-Bank Financial Institutions Regulatory Authority",
    version: "NBFIRA Act 2016 (as amended)",
    category: "Financial Services",
    authority: "Non-Bank Financial Institutions Regulatory Authority (NBIFIRA)",
    description: "Regulates insurers, pension funds, capital markets, and micro-lenders in Botswana; enforces prudential, conduct, and AML/CFT standards for non-bank financial institutions.",
    mandatory: true,
    controls_count: 38,
    key_requirements: ["Licensing & prudential supervision", "Capital adequacy & solvency", "Conduct of business standards", "AML/CFT compliance", "Consumer protection & complaints", "Corporate governance", "Regulatory reporting"],
    related_international: ["IAIS", "IOSCO", "FATF"],
    tags: ["financial services", "insurance", "pensions", "botswana", "mandatory"],
  },
  {
    id: "bera_bw",
    region: "Botswana",
    flag: "🇧🇼",
    name: "BERA",
    full_name: "Botswana Energy Regulatory Authority",
    version: "BERA Act 2016 (as amended)",
    category: "Energy & Utilities",
    authority: "Botswana Energy Regulatory Authority (BERA)",
    description: "Regulates electricity, gas, and downstream energy sectors in Botswana; enforces licensing, tariff, safety, and environmental compliance across the energy value chain.",
    mandatory: true,
    controls_count: 26,
    key_requirements: ["Generation, transmission & distribution licensing", "Tariff regulation & cost-reflective pricing", "Safety & technical standards", "Environmental compliance", "Consumer protection", "Renewable energy integration", "Regulatory reporting"],
    related_international: ["IEC", "ISO 50001", "NERSA"],
    tags: ["energy", "utilities", "electricity", "botswana", "mandatory"],
  },
  {
    id: "ppra_bw",
    region: "Botswana",
    flag: "🇧🇼",
    name: "PPRA",
    full_name: "Public Procurement Regulatory Authority (PPRA / PPADB)",
    version: "PPADB Act 2001 (as amended)",
    category: "Procurement & Public Finance",
    authority: "Public Procurement Regulatory Authority (PPRA)",
    description: "Regulates public procurement and asset disposal in Botswana; enforces transparency, fairness, value-for-money, and supplier compliance across all procuring entities.",
    mandatory: true,
    controls_count: 24,
    key_requirements: ["Procurement planning & threshold compliance", "Open & competitive tendering", "Supplier registration & due diligence", "Anti-corruption & conflict of interest", "Contract management", "Asset disposal controls", "Audit & procurement review"],
    related_international: ["UNCAC", "OECD Procurement", "World Bank"],
    tags: ["procurement", "public finance", "transparency", "botswana", "mandatory"],
  },
  {
    id: "cipa_bw",
    region: "Botswana",
    flag: "🇧🇼",
    name: "CIPA",
    full_name: "Companies and Intellectual Property Authority",
    version: "CIPA Act 2020 (as amended)",
    category: "Corporate Registry & IP",
    authority: "Companies and Intellectual Property Authority (CIPA)",
    description: "Administers company registrations, intellectual property, and business licensing in Botswana; enforces filings, beneficial ownership, and corporate governance disclosures.",
    mandatory: true,
    controls_count: 22,
    key_requirements: ["Company registration & annual returns", "Beneficial ownership disclosure", "Director & officer filings", "Trademark & patent registration", "Business name reservation", "Compliance enforcement & strikes", "Data integrity & public registry"],
    related_international: ["UNCAC", "OECD Corporate Governance", "WIPO"],
    tags: ["corporate registry", "intellectual property", "governance", "botswana", "mandatory"],
  },
  {
    id: "bob_bw",
    region: "Botswana",
    ...
    full_name: "Bank of Botswana — Banking Act & Prudential Regulations",
    version: "Banking Act 1995 (as amended)",
    category: "Financial Services",
    authority: "Bank of Botswana (BoB)",
    description: "Central bank of Botswana regulating banks and payment systems; enforces capital adequacy, liquidity, AML/CFT, and cyber resilience under the Banking Act and prudential directives.",
    mandatory: true,
    controls_count: 48,
    key_requirements: ["Banking licence supervision", "Capital adequacy (Basel)", "Liquidity & reserve requirements", "AML/CFT & sanctions compliance", "Cybersecurity & operational resilience", "Payment systems oversight", "Regulatory reporting (BSRs)"],
    related_international: ["Basel III", "FATF", "ISO 27001", "NIST CSF"],
    tags: ["financial services", "banking", "central bank", "botswana", "mandatory"],
  },
  {
    id: "bica_bw",
    region: "Botswana",
    flag: "🇧🇼",
    name: "BICA",
    full_name: "Botswana Institute of Accountants & Audit Profession Act",
    version: "BICA Act 2010 (as amended)",
    category: "Professional Services & Audit",
    authority: "Botswana Institute of Accountants (BICA)",
    description: "Regulates the accountancy and audit profession in Botswana; sets professional standards, CPD, ethics, and quality assurance for auditors and accountants.",
    mandatory: true,
    controls_count: 22,
    key_requirements: ["Professional registration & licensing", "Continuing Professional Development (CPD)", "Code of ethics & independence", "Audit quality & inspection", "IFRS/BAS adoption", "Disciplinary procedures", "Quality assurance reviews"],
    related_international: ["IFAC", "IESBA", "ISA"],
    tags: ["professional services", "audit", "accountancy", "botswana", "mandatory"],
  },
  {
    id: "rera_bw",
    region: "Botswana",
    flag: "🇧🇼",
    name: "RERA",
    full_name: "Real Estate Regulatory Authority",
    version: "Real Estate Profession Act (as amended)",
    category: "Real Estate & Property",
    authority: "Real Estate Regulatory Authority (RERA)",
    description: "Regulates the real estate sector and property practitioners in Botswana; enforces licensing, conduct, trust account, and consumer protection standards.",
    mandatory: true,
    controls_count: 20,
    key_requirements: ["Estate agent licensing & registration", "Trust account & fiduciary controls", "Conduct & ethics standards", "Property disclosure & valuation", "Consumer protection & disputes", "Continuing education", "Compliance inspections"],
    related_international: ["RICS", "IVSC"],
    tags: ["real estate", "property", "botswana", "mandatory"],
  },
  {
    id: "ca_bw",
    region: "Botswana",
    ...
    full_name: "Competition Authority of Botswana — Competition Act",
    version: "Competition Act 2018 (as amended)",
    category: "Competition & Antitrust",
    authority: "Competition Authority (CA)",
    description: "Enforces competition law in Botswana; regulates mergers, restrictive practices, abuse of dominance, and consumer protection against unfair trade practices.",
    mandatory: true,
    controls_count: 20,
    key_requirements: ["Merger notification & approval", "Restrictive practice prohibition", "Abuse of dominance prevention", "Consumer protection enforcement", "Market inquiries & investigations", "Penalty & remedial orders", "Compliance programmes"],
    related_international: ["UNCAC", "OECD Competition", "ICN"],
    tags: ["competition", "antitrust", "consumer protection", "botswana", "mandatory"],
  },
  {
    id: "mot_bw",
    region: "Botswana",
    ...
    full_name: "Ministry of Trade & Industry — Trade & Industrial Policy",
    version: "Trade & Industrial Policy (current)",
    category: "Trade & Industry",
    authority: "Ministry of Trade & Industry (Botswana)",
    description: "Formulates and enforces trade, industrial, and investment policy in Botswana; oversees licences, local content, SEZs, and trade-facilitation compliance.",
    mandatory: true,
    controls_count: 22,
    key_requirements: ["Trade & business licensing", "Local content & citizen economic empowerment", "Import/export controls", "Special Economic Zone compliance", "Investment promotion & incentives", "Trade-facilitation & WTO alignment", "Industrial policy reporting"],
    related_international: ["WTO", "AfCFTA", "SADC FTA"],
    tags: ["trade", "industry", "investment", "botswana", "mandatory"],
  },
  {
    id: "mof_bw",
    region: "Botswana",
    ...
    full_name: "Ministry of Finance — Public Finance & Economic Governance",
    version: "Public Finance Management Act (current)",
    category: "Public Finance & Governance",
    authority: "Ministry of Finance (Botswana)",
    description: "Oversees public finance, fiscal policy, and economic governance in Botswana; enforces budget discipline, internal controls, and public-sector risk management.",
    mandatory: true,
    controls_count: 26,
    key_requirements: ["Budget & fiscal discipline", "Internal controls & assurance", "Public-sector risk management", "Procurement oversight", "Treasury & cash management", "Debt & investment governance", "Financial reporting (IPSAS)"],
    related_international: ["IPSAS", "COSO ERM", "INTOSAI"],
    tags: ["public finance", "governance", "fiscal", "botswana", "mandatory"],
  },
  {
    id: "boccim_bw",
    region: "Botswana",
    flag: "🇧🇼",
    name: "BOCCIM",
    full_name: "Botswana Confederation of Commerce, Industry and Manpower",
    version: "Voluntary Code (current)",
    category: "Business & Industry",
    authority: "BOCCIM",
    description: "Apex employer and business membership organisation in Botswana; sets voluntary corporate governance, labour, and enterprise standards for members across commerce and industry.",
    mandatory: false,
    controls_count: 18,
    key_requirements: ["Corporate governance codes", "Labour & manpower standards", "Enterprise & SME development", "Occupational health & safety", "Business ethics & anti-corruption", "Industry advocacy & compliance", "Member self-regulation"],
    related_international: ["IOE", "ISO 26000", "UN GC"],
    tags: ["business", "industry", "labour", "botswana"],
  },
  {
    id: "burs_bw",
    region: "Botswana",
    flag: "🇧🇼",
    name: "BURS",
    full_name: "Botswana Unified Revenue Service — Tax Administration Act",
    version: "Tax Administration Act 2003 (as amended)",
    category: "Tax & Revenue",
    authority: "Botswana Unified Revenue Service (BURS)",
    description: "Administers tax, customs, and excise in Botswana; enforces registration, filing, payment, audit, and anti-evasion controls across VAT, income tax, and customs.",
    mandatory: true,
    controls_count: 32,
    key_requirements: ["Taxpayer registration & TIN", "VAT & income tax filing", "Transfer pricing & thin capitalisation", "Customs & excise controls", "Tax audit & investigation", "Anti-evasion & penalties", "Data security & confidentiality"],
    related_international: ["OECD TP", "WCO", "FATF"],
    tags: ["tax", "revenue", "customs", "botswana", "mandatory"],
  },
  {
    id: "naftech_bw",
    region: "Botswana",
    flag: "🇧🇼",
    name: "NAFTECH",
    full_name: "National Food Technology Research Centre — Food Safety & Standards",
    version: "FOA Standards (current)",
    category: "Food Safety & Standards",
    authority: "National Food Technology Research Centre (NAFTECH)",
    description: "Botswana's food technology and standards institution; promotes food safety, quality assurance, and HACCP compliance across food production and processing.",
    mandatory: false,
    controls_count: 20,
    key_requirements: ["Food safety & HACCP", "Quality assurance systems", "Product testing & certification", "Labelling & standards compliance", "Hygiene & sanitation controls", "Traceability & recall", "Research & technology transfer"],
    related_international: ["HACCP", "ISO 22000", "Codex Alimentarius"],
    tags: ["food safety", "standards", "quality", "botswana"],
  },
];
